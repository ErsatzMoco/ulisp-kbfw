...
// RP2040 boards ***************************************************************
...
#elif defined(ARDUINO_RASPBERRY_PI_PICO) || defined(ARDUINO_PIMORONI_TINY2040) \
  || defined(ARDUINO_WAVESHARE_RP2040_ZERO) || defined(ARDUINO_ADAFRUIT_QTPY_RP2040) \
  ...
  #elif defined(rfm69) && (defined(ARDUINO_PIMORONI_TINY2040) || defined(ARDUINO_WAVESHARE_RP2040_ZERO))
...
// Simplify board differences
  ...
  || defined(ARDUINO_PIMORONI_TINY2040) || defined(ARDUINO_WAVESHARE_RP2040_ZERO) \
...
void initgfx () {
  ...
  // pinMode(TFT_BACKLIGHT, OUTPUT);
  // digitalWrite(TFT_BACKLIGHT, HIGH);
  #elif defined(ARDUINO_PIMORONI_TINY2040) || defined(ARDUINO_WAVESHARE_RP2040_ZERO) || defined(ARDUINO_RASPBERRY_PI_PICO) || defined(ARDUINO_RASPBERRY_PI_PICO_2)
  SPI.setTX(PIN_TFT_MOSI);
  SPI.setSCK(PIN_TFT_SCLK);
  SPI.setCS(PIN_TFT_CS);
